        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="table-responsive">
                ...
                <tbody>
                        <?php
                            $sql = mysql_query("SELECT * FROM data WHERE poin>=25 and poin<50 order by tahun desc");
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="table-responsive">
                ...
                <tbody>
                        <?php
                            $sql = mysql_query("SELECT * FROM data WHERE poin>=50 and poin<80 order by tahun desc");
                            $mysql = mysql_query("SELECT tahun from aplikasi");
                            $row = mysql_fetch_array($mysql);
                            $tahun = $row['tahun'];
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="table-responsive">
                ...
                <tbody>
                        <?php
                            $sql = mysql_query("SELECT * FROM data WHERE poin>=80 and poin<=100 order by tahun desc");
